            ...
            row.innerHTML = `
                ...
                <td>
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="font-monospace d-none d-lg-inline">${product.colorShade}</span>
                    </div>
                </td>
                <td class="d-none d-lg-table-cell">${product.ciGenericName}</td>
                <td class="font-monospace d-none d-xl-table-cell">${product.casNumber}</td>
            ...
            card.innerHTML = `
                ...
                <div class="product-card-body">
                    <div class="product-card-field">
                        <div class="product-card-label">Category</div>
                        <div class="product-card-value">
                            <span class="badge bg-secondary">${product.category}</span>
                        </div>
                    </div>
                    <div class="product-card-field">
                        <div class="product-card-label">Color Shade</div>
                        <div class="product-card-value product-card-color">
                            <div class="color-swatch-mobile" style="background-color: ${product.colorShade};"></div>
                            <span class="font-monospace">${product.colorShade}</span>
                        </div>
                    </div>
                    <div class="product-card-field">
                        <div class="product-card-label">CI Generic Name</div>
                        <div class="product-card-value">${product.ciGenericName}</div>
                    </div>
                    <div class="product-card-field">
                        <div class="product-card-label">CAS Number</div>
                        <div class="product-card-value font-monospace">${product.casNumber}</div>
                    </div>
                </div>
                <div class="product-card-actions">
                    <button class="btn btn-sm btn-outline-primary btn-touch" onclick="editProduct(${product.id})" title="Edit">
                        <i class="bi bi-pencil me-1"></i>Edit
                    </button>
                    <button class="btn btn-sm btn-outline-danger btn-touch" onclick="deleteProduct(${product.id})" title="Delete">
...
// Function to setup mobile sidebar handlers
